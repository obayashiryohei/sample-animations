...
const cssSass = () => {
    return src(srcPath.css)
        ...
        .pipe(notify({
            message: 'コンパイル出来たじぇ〜',//コンパイル成功時:文字は好きなものに変更してね！
...
const watchFiles = () => {
    ...
    watch(srcPath.js, series(jsBabel, browserSyncReload)) // src/jsフォルダ内の変更があったら画像圧縮して自動リロード
...
exports.default = series(series(clean, cssSass, imgImagemin,jsBabel), parallel(watchFiles, browserSyncFunc));
